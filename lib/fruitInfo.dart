...
String moisture = 'NaN';
String methane = 'NaN';
String carbonMonoxide = 'NaN';

final userDoc = FirebaseFirestore.instance.collection("Users");

const goodConditionColor = 0xffFFFFFF;
const badConditionColor = 0xffFF9699;
...
String fruitName='NaN';

class FruitsInfo extends StatefulWidget {
  // String fruitName;
  // FruitsInfo({super.key, this.fruitName});
  // final String title;

  void onInit(){
    fruitName = Get.arguments[0];
    print('fruit name : $fruitName');

  }

  @override
  State<FruitsInfo> createState() => FruitsInfoState();
}

class FruitsInfoState extends State<FruitsInfo>{
